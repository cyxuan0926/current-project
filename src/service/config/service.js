...
instance.interceptors.request.use(
  config => {
    ...
    if (config.url && !config.url.includes('/prisoners/processing') && !config.url.includes('/prisoners/validate') && !config.url.includes('/upload/uploadfile')) store.commit('showLoading')
    state = history.state
