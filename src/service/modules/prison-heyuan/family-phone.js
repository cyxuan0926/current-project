...
export default {
    ...
    // 亲情监管 亲情电话家属详情
    getIntraFamilyInfo: params => service.get(service.getHyUrl('/familyPhoneManage/familyDetail'), params),
    // 查询亲情电话申请列表
     familyPhoneList: params => {
          return service.get(service.getHyUrl('/parse/familyphone/apply/page'), params).then(res => res && res.data)
     },
   // 查询亲情电话申请详情
     familyPhoneDetail: params => {
          return service.get(service.getHyUrl('/parse/familyphone/apply/detail'), params).then(res => res && res.data)
     },
    // 新增亲情电话申请
      familyPhoneAdd: data => {
   ...
   // 亲情电话通话费用结算表列表查询
      phoneSettleAccountsList: params => {
        return service.get(service.getHyUrl('/settleAccounts/findPage'), params).then(res => res && res.data)
  }
}
