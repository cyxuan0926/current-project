<template>
  <div class="el-row_step-three">
    ...
    >
      ...
      <el-form-item size="large" label-width="28%">
        <el-button type="primary" @click="handleSubmit">确定</el-button>

        <el-button type="primary" @click="handleSetStepAndRouter({ step: 1, path: '/password_retrieve/step_two' })">上一步</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
